...
//
// Lets cc-alt connect to external MCP servers (Claude-Desktop-compatible config) and surface
...
// rest of cc-alt is untouched.

import { spawn } from "node:child_process";

const PROTOCOL_VERSION = "2025-06-18";
const CLIENT_INFO = { name: "cc-alt", version: "0.1.0" };
